...
(function () {
  var btnFindStation = document.querySelector('#btn-find-station');
  var inputLatitude = document.querySelector('#input-latitude');
  var inputLongitude = document.querySelector('#input-longitude');
  var inputRadius = document.querySelector('#input-radius');
  ...
  var getStations = function getStations(latitude, longitude, radius) {
    axios.get('/api/stations/nearby', {
      ...
      if (response.status === 200) {
        ...
        (function () {
          ...
          var stations = responseData.data;
          var stationsList = document.querySelector('#stations-list');
          stationsList.innerHTML = ''; // stations.map(station => {
          // console.log(stations)
          // });

          for (stationAddress in stations) {
            console.log(stationAddress);
            var stationList = stations[stationAddress];
            console.log(stationList);
            stationList.map(function (station) {
              console.log(station);
              var stationItem = document.createElement('li');
              stationItem.innerHTML = "\n                            <div class=\"card\">\n                                <div class=\"card-body\">\n                                    <h5 class=\"card-title\">".concat(station.name, "</h5>\n                                    <p class=\"card-text\">").concat(station.address, "</p>\n                                    <p class=\"card-text\">").concat(station.distance, "</p>\n                                </div>\n                            </div>\n                        ");
